...
class Process:
    debug = DEBUG
    resultDir = 'output/cpu_result'
    figureDir = 'output/cpu_result/figure'
    ...
    def __init__(self, topk):
        ...
        self.str_QPS = 'QPS'
        if not os.path.exists(self.figureDir):
    ...
    def plotMultiThreadQPS(self, recall_rate=0.90):
        ...
        for datasize in Datasize:
            ...
            fig, ax = plt.subplots(1, num_dataset, figsize=(5*num_dataset, 5), sharex=True, sharey=True)
            ...
            for ds_i, dataset in enumerate(Dataset):
                ...
                ax[ds_i].plot(labels, values, marker='h', linestyle='dashed')
                # reference curve
            ...
            suptitle = 'Throughput of HNSW on multithreading'
